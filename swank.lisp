      ...
      (macrolet ((maybe-value-string (form)
        ...
        (let* ((*trace-output*
          ...
          (if targets-provided-p
              ...
              ;; - can very likely be dropped when Emacs 27 becomes unsupported
              ;;   TODO: replace /very likely/ above with /certainly/
              ;;   once the support for multiple output gets merged into Org
